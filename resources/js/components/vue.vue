                ...
                <form>
                    <div class="space-y-12" id="form11">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <!-- file import java -->
                            <div class="sm:col-span-3">
                                <label for="flile" class="block text-sm font-medium leading-6 text-gray-900">Upload do
                                    ficheiro*</label>
                                <div class="mt-2">
                                    <input type="file"
                            ...
                            <div class="sm:col-span-3">
                                <Listbox as="div" v-model="selected">
                                    <ListboxLabel class="block text-sm font-medium leading-6 text-black-900">Tipo de viatura* </ListboxLabel>
                    ...
                    <div>
                        <button type="button" @click="addPfuxelaCliente()" id="btn11"
                            class="btn flex w-full justify-center rounded-md bg-indigo-600 px-3 py-3.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ">Requisitar</button>
